...
public class  CreditCardPayemenet implements PayementProcessor
{
    ...
    
    {
    	...
    	{
			System.out.println("Processing Credit Card payemnet of :"+amount);
			System.out.println("Transacation is valid"+validatePayemnet(amount));
			System.out.println("Credit Card Paymnet sucessful");
